...
const cartSlice = createSlice({
    ...
    reducers: {
        ...
        addItem(state, action) {
            ...
            if (!existingItem) {
                // if just use redux, you should not mute state array instead of
                // clone the state array, but if use redux toolkit that will not a
                // a problem because redux toolkit clone the array behind the scene
