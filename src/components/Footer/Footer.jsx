...
import rubyLogo from '../../assets/images/ruby-favicon-color.png';
                ...
                <Row>
                    <Col lg="3" md="4" sm="6">
                        <div className="logo text-start ">
                            {/* <svg viewBox="0 0 192 65" className="logo__footer">
                                <g fillRule="evenodd">
                            ...
                            <img src={rubyLogo} alt="" className="logo__footer" />
                            <h5>Ruby</h5>
                            {/* <h6>Ruby</h6> */}
                        </div>
                        <p>
                    ...
                    <Col lg="3" md="4" sm="6" className="footer__customer">
                        <h5 className="footer__title">Customer Care</h5>
                        <ListGroup className="delivery__time-list">
                            <ListGroupItem className="delivery__time-item border-0 ps-0">
                                <h6 className="contact-info">
                                    <Link className="navigate-footer" to="/login">
                                        Login
                                    </Link>
                                </h6>
                            </ListGroupItem>
                            <ListGroupItem className="delivery__time-item border-0 ps-0">
                                <h6 className="contact-info">
                                    <Link className="navigate-footer" to="/register">
                                        Register
                                    </Link>
                                </h6>
                            </ListGroupItem>
                            <ListGroupItem className="delivery__time-item border-0 ps-0">
                                <h6 className="contact-info">
                                    <Link className="navigate-footer" to="/cart">
                                        Cart
                                    </Link>
                                </h6>
                            </ListGroupItem>
                    ...
                    <Col lg="3" md="12" sm="6" className=" footer-letter__checkout">
                    ...
                    <Row className="footer__follow">
                        <Col lg="6" md="12">
                            <div className="d-flex align-items-center justify-content-between footer-copyright__follow">
                        ...
                        <Col lg="6" md="12">
                            <div className=" footer-copyright__follow">
                                <p className="copyright__text  ">
                                    Copyright - 2024, website made by Tam Nguyen. All rights reserved
                                </p>
                            </div>
                        </Col>
                    </Row>
